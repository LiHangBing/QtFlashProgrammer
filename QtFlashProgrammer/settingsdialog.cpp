...
void SettingsDialog::fillPortsParameters()
{
    ...
    m_ui->baudRateBox->addItem(QStringLiteral("100000"), 100000);
    m_ui->baudRateBox->addItem(QStringLiteral("256000"), 256000);
    m_ui->baudRateBox->addItem(QStringLiteral("200000"), 200000);
    m_ui->baudRateBox->addItem(QStringLiteral("400000"), 400000);
